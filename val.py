...
menu3 = types.KeyboardButton("Купить подарок 🎁")
menu4 = types.KeyboardButton("Основные вопросы ❓")
menu8 = types.KeyboardButton("Как нас найти 🎯")
menu9 = types.KeyboardButton("Контакты 📞")
menu.add(menu1, menu2, menu3, menu4, menu8, menu9)
...
contacts = "Телефон для связи +7(800)775-97-11 \nнаписать нашему администратору (@aerodream_aerotruba)"
